...
export function getCountryName(codeOrName?: string | null) {
...
export function formatCountryLabel(codeOrName?: string | null) {
...
export function buildPageHref(pathname?: string | null, siteDomain?: string | null) {
  if (!pathname) return "";
